...
\begin{center}
  ...
  \vspace{0.5em}
  \centerline{\textsc{\Large Maximum Likelihood - EM Algorithm}}
  \vspace{1em}
  \textsc{\large CMU 11-755/18-797: Machine Learning for Signal Processing (Fall 2019)} \\
  \vspace{1em}
  \centerline{OUT: November 8th, 2020 }
  \centerline{DUE: {\bf November 23rd, 11:59 PM}}
\end{center}
\graphicspath{images}
